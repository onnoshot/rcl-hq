...
export async function detail(req, res) {
  ...
  const { data: cam } = await db.from('cameras').select('id,handle,brand,model,title,image_url,price,product_url,score,votes_count,photo_count,year,highlight').eq('id', id).maybeSingle();
