...
SHOPIFY_TOKEN = "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"
# 2026-09-24: eski token'da write_content scope'u yoktu (blog yayını 403 veriyordu).
# BLOGGERSON custom app'i (OAuth ile) read_content+write_content+read_products+
# read_orders+read_customers scope'larıyla yenisi alındı.
...
<p style="margin:0 0 8px 0;font-weight:700;font-size:16px;">📸 Retrocameraland'i Takip Edin</p>
<p style="margin:0;line-height:1.8;">📷 <a href="https://instagram.com/retrocameraland">instagram.com/retrocameraland</a><br>▶️ <a href="https://youtube.com/@retrocameraland">youtube.com/@retrocameraland</a><br>🎵 <a href="https://tiktok.com/@retrocameraland">tiktok.com/@retrocameraland</a></p>
</div>"""
